...
<tr>
<td colspan="5"><h4>Room Realted Info</h4></td>
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/pg/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
...
<td colspan="6"><h4>Personal Info</h4></td>
	...
	<tr>
		<td><b>Full Name :</b></td>
		<td colspan="2"><?php echo $row->firstName . ' ' . $row->middleName . ' ' . $row->lastName; ?></td>
		<td><b>Email :</b></td>
	...
	<tr>
		...
		<td colspan="5"><?php echo $row->egycontactno; ?></td>
	</tr>
